...
<!--     <td><div align="center"><!-- <a href="product_photos_edit.jsp?id=<%=id%>"class="btn btn-primary" title="Edit"><i class="bi bi-pencil"></i></a> --> <!-- <a href="product_photos_delete.jsp?id=<%=id%>"class="btn btn-danger" title="Delete"><i class="bi bi-trash"></i></a> --> </div></td></tr>
  </tbody>
 <%
 }
 %>
