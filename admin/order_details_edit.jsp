...
<input type="hidden" name="b" value="<%=b%>">
    ...
    <div class="col-12">
        ...
        <input class="validate[required,custom[onlyNumber] form-control" style="width:90%" readonly="" name="pid" type="text" id="pid" value="<%=rs.getString("pr_id")%>">
        </div><br>
		
    <div class="col-12">
           <label for="inputName4" class="form-label">Quantity</label>
        <input class="validate[required,custom[onlyNumber] form-control" style="width:90%" readonly="" name="qu" type="number" min="1" max="10" id="qu" value="<%=rs.getString("quantity")%>">
      </div><br>
   
    <div class="col-12">
           <label for="inputName4" class="form-label">Shipping ID</label>
        <input class="validate[required,custom[onlyNumber] form-control" style="width:90%" readonly="" name="shi" type="text" id="shi" value="<%=rs.getString("sp_id")%>">
      </div><br>
    
	<div class="col-12">
           <label for="inputName4" class="form-label">Order Date</label>
        <input class="validate[required,custom[date]] form-control" style="width:90%" readonly="" name="od" type="text" id="od" value="<%=rs.getString("o_date")%>">
      </div><br>
