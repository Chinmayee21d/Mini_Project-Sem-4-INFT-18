...
<form id="WFS_Riz" action="product_details_insert.jsp" method="post" class="style1">
    ...
    <div class="col-12">
          ...
          <input class="validate[required,custom[onlyLetters]] form-control" autocomplete="off" style="width:90%" name="pn" type="text" id="pn">
        </div><br>
	...
	<div class="col-12">
          ...
          <input class="validate[required,custom[onlyNumbers]] form-control" style="width:90%" name="pp" type="text" id="pp">
        </div><br>
