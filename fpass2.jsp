	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form id="WFS_Riz" method="post" action="resetf.jsp" class="login100-form validate-form">
				<input type="hidden" name="uname" value="<%=un%>">
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" class="validate[required,custom[onlyLetter]]" value="<%=rs.getString("s_question")%>" readonly=""  type="text" name="sq">
						<span class="focus-input100"></span>
						<span class="label-input100">Security Question</span>
					</div>
					
					<div class="wrap-input100 validate-input" >
						<input  class="input100" class="validate[required,custom[onlyLetter]]"  type="password" name="sa">
						<span class="focus-input100"></span>
