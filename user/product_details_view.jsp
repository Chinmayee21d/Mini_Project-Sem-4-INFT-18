...
<!-- Main -->
 <main id="main" class="main">
  ...
  <tr>
    ...
    <td width="100"><div align="center"><strong>Product View</strong></div></td>
  </tr>
  </thead>
...
<%
int sin=0;
ResultSet rs=s.stm.executeQuery("Select * from product_photos s, product_details p, sub_category d where s.pr_id=p.pr_id and p.sct_id=d.sct_id");
while(rs.next())
{
sin++;
...
<tbody>
  <tr>
    ...
    <td><div align="center"><a href="product_photos_view.jsp?id=<%=id%>" title="View Photo">
    <img src="../uploads/<%=rs.getString("pr_photo1")%>" alt="View Photo" class="btn btn-info" />
</a>
</div></td>
