...
<form id="WFS_Riz" name="form1" method="post" action="bank_details_insert.jsp" class="style1">
   ...
   <div class="col-12">
      <label for="inputName4" class="form-label">Bank Name</label>
        <input class="validate[required,custom[onlyLetter]] form-control" autocomplete="off" style="width:90%" name="bn" type="text" id="bn">
      </div><br>
	  
      <div class="col-12">
      <label for="inputName4" class="form-label">UPI</label>
        <input class="validate[required] form-control" style="width:90%" autocomplete="off" name="upi" type="text" id="upi">
      </div><br>
	 ...
	 <div class="col-12">
      <label for="inputName4" class="form-label">Account Holder</label>
		...
		%>
		 ...
		 <div class="col-12">
      <label for="inputName4" class="form-label">Payment Status</label>
        <input class="validate[required] form-control" value="Paid" readonly="" style="width:90%" name="am" type="text" id="am">
      </div><br> 
