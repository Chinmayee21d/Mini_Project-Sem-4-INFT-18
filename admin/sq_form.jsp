...
ResultSet rs=s.stm.executeQuery("Select s_question as sq,s_answer as sa  from login  where username='"+un+"'");
rs.next();
...
<form id="WFS_Riz" name="form1" method="post" action="sq_insert.jsp" class="style1">
   <div class="col-12">
	  ...
	  <div class="col-12">
      <label for="inputName4" class="form-label">Answer</label>
        <input class="validate[required] form-control" style="width:90%" name="sa" type="password" id="sa" value="<%=sa%>">
      </div><br>
